...
def updateHand(hand, word):
    ...
    newHand = hand.copy()
    for char in newHand:
        if char in word and newHand[char] > 0:
            newHand[char] = newHand[char] - word.count(char)
    return newHand
...
def playGame(wordList):
    ...
    player_command = None
    player_hand = None
    while player_command != 'e':
        player_command = raw_input("Enter n to deal a new hand, r to replay the" +
